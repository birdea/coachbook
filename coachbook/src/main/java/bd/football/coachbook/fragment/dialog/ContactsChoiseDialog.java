...
public class ContactsChoiseDialog extends Dialog {

	public ContactsChoiseDialog(Context context, ArrayList<MemberParam> list, OnItemClickListener onItemClickListener) {
		super(context);
